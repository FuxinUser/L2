...
namespace L2
{
    ...
    {
        public static object RawDeserialize(byte[] byteData, Type type, bool is_ConvertEndian)
        {
            try
            {
        ...
        public static byte[] RawSerialize(object type, bool is_ConvertEndian)
        {
            try
            {
                int rawsize = Marshal.SizeOf(type);
        ...
        public static byte[] ConvertEndian(byte[] byteData, Type type, int iCursor = 0)
        {
            int iMLength = 0;
            bool bIsArray = false;
            int iSizeConst = 0;
